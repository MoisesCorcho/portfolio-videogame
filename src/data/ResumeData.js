export const ResumeData = {
    profile: {
        ...
        summary: "Soy un desarrollador backend formado tanto en entornos académicos como empresariales. Mi enfoque en PHP, Laravel y bases de datos se ha fortalecido a través de proyectos reales y personales. Mi pasión por el aprendizaje y la resolución lógica de problemas se combina con habilidades de empatía y escucha activa.",
        contact: {
    ...
    experience: [
        {
            ...
            description: "Realicé un rebranding completo de la Landing Page y el Panel de Usuario de la plataforma de Exchange andrestelocambia, migrando toda la interfaz de Bootstrap a Tailwind CSS. Se refactorizaron módulos críticos como el flujo de envío de dinero. Implementación de OAuth con Google y Google Reviews vía SerpApi.",
    ...
    skills: {
        languages: ["PHP (Avanzado)", "JavaScript (Intermedio)", "HTML5", "Java (Básico)", "SQL"],
        frameworks: ["Laravel (Avanzado)", "Livewire", "Filament", "TailwindCSS", "Bootstrap", "jQuery"],
        tools: ["Git/GitHub", "Docker", "Composer", "Postman", "SQL Server", "MySQL", "PostgreSQL"],
        concepts: ["MVC", "SOLID", "Clean Code", "REST APIs", "Unit Testing (PHPUnit/Pest)"]
    },
    education: [
        {
            id: "edu_ucc",
